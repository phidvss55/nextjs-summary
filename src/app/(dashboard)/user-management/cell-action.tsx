...
export const CellActions = ({ id, name, role, email, emailVerified, hasDeletePermission }: UserProps) => {
    ...
    <>
      ...
      >
        <DialogContent className="flex flex-col items-start justify-center">
          ...
          <Button type="submit" className="cursor-pointer max-w-40 self-end my-6" variant="destructive" onClick={onRemoveUser}>
