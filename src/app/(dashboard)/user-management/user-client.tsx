    ...
    <>
      ...
      >
        <DialogContent>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} id="user-management" className="flex flex-col items-end justify-center">
            <FieldGroup>
              <Controller
                name="name"
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid} className="gap-1">
                    ...
                    <Select {...field} onValueChange={field.onChange} defaultValue={user.role}>
