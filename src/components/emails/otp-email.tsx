    ...
    <Tailwind>
      <Body className="bg-white font-Betterauth-next">
        ...
        <Container className="mx-auto py-5 pb-12">
          <Text className="text-[16px] leading-[26px]">Please find your code to login below</Text>

          <Text className="text-[40px] leading-5">{otp}</Text>

          <Text className="text-[#8898aa] text-[12px]">If you did not request a code, you can safely ignore this email.</Text>
        </Container>
      </Body>
    </Tailwind>
  </Html>
