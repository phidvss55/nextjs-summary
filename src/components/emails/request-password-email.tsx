      ...
      <Body className="bg-white font-Betterauth-next">
        ...
        <Container className="mx-auto py-5 pb-12">
          ...
          <Section className="text-center">
            <Button className="bg-[#5F51E8] rounded-[3px] text-white text-[16px] no-underline text-center block p-3" href={url}>
              Reset your password
            </Button>
          </Section>

          <Text className="text-[#8898aa] text-[12px]">If you did not request for password reset, you can safely ignore this email.</Text>
        </Container>
      </Body>
    </Tailwind>
  </Html>
