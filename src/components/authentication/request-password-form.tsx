    ...
    <>
      {isEmailSent ? (
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <div className="flex w-full p-6">A password reset link has been sent to your email.</div>
          ...
          <CardContent>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6" id="reset-password">
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid} className="gap-1">
                      ...
                      <Input {...field} autoComplete="off" type="email" aria-invalid={fieldState.invalid} />
              ...
              <Button
                ...
                form="reset-password"
              >
                {form.formState.isSubmitting ? <Spinner className="size-6" /> : 'Send request'}
              </Button>
            </form>
          </CardContent>
        </Card>
